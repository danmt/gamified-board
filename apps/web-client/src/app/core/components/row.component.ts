...
import { InstructionApplicationTooltipDirective } from '../../instruction-application/components';
import { InstructionDocumentTooltipDirective } from '../../instruction-document/components';
import { InstructionSignerTooltipDirective } from '../../instruction-signer/components';
import { InstructionSysvarTooltipDirective } from '../../instruction-sysvar/components';
import { InstructionTaskTooltipDirective } from '../../instruction-task/components';

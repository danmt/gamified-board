    ...
    >
      ...
      <div class="bg-gray-800 relative w-[2.89rem] h-[2.89rem]">
        <span
          ...
          (pgKeyDown)="onToggleProgramsInventoryModal()"
        >
          .
        </span>
        ...
        <pg-square-button
          pgThumbnailUrl="assets/generic/instruction.png"
          (click)="onToggleProgramsInventoryModal()"
        ></pg-square-button>
      </div>
    </pg-corner-dock>
  `,
...
export class RightDockComponent {
  ...
  @Output() pgToggleProgramsInventoryModal = new EventEmitter();

  onActivateField() {
    this.pgActivateField.emit();
  }

  onToggleProgramsInventoryModal() {
    this.pgToggleProgramsInventoryModal.emit();
  }
}

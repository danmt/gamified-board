...
export class CursorScrollDirective {
  ...
  @HostListener('window:mousemove', ['$event']) onMouseMove(event: MouseEvent) {
    if (
      ...
      isNull(this._movingRightSubscription)
    ) {
      this._moveRight();
    } else if (
      !this._isInRightBorder(event.clientX) &&
      isNotNull(this._movingRightSubscription)
    ) {
    ...
    if (
      ...
      isNull(this._movingLeftSubscription)
    ) {
      this._moveLeft();
    } else if (
      !this._isInLeftBorder(event.clientX) &&
      isNotNull(this._movingLeftSubscription)
    ) {
    ...
    if (
      ...
      isNull(this._movingBottomSubscription)
    ) {
      this._moveBottom();
    } else if (
      !this._isInBottomBorder(event.clientY) &&
      isNotNull(this._movingBottomSubscription)
    ) {
    ...
    if (
      ...
      isNull(this._movingTopSubscription)
    ) {
      this._moveTop();
    } else if (
      !this._isInTopBorder(event.clientY) &&
      isNotNull(this._movingTopSubscription)
    ) {
      this._stopMovingTop();
    }
  }
